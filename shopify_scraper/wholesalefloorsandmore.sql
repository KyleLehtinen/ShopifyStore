...
CREATE TABLE ShopifyImportMaster(
	...
	`Option1 Value` varchar(255) NOT NULL,
	...
	`Variant Fulfillment Service` varchar(255) NOT NULL,
	`Variant Price` int NOT NULL,
	`Variant Compare At Price` int NOT NULL,	
